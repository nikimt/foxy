  ...
  renderStatus() {
    ...
    if (game.status === GameStatuses.STARTED) {
      ...
      if (playerIndex === null) {
        ...
        status = `Finished: winner: ` + playerIndex;
        ...
        <div className="ui top attached header">
          <div className="ui grid">
            <div className="ui three column center-aligned row">
              ...
              <div className="ui column">
                {this.props.game.players[1].username} as {this.props.game.players[1].role}<br/>Number of diamonds: {this.props.game.players[1].diamonds}
              </div>
              <div className="ui column">
                Total diamonds needed: {this.props.game.diamondsNeeded} || Total diamonds stolen: {this.props.game.totalDiamonds}
              </div>
            </div>
          </div>
        </div>
